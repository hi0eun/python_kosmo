...
print('{0}년 {1}월 {2}일'.format(naljja[:4],naljja[5:7],naljja[8:10]))
print(naljja[-8:-6]+'시'+naljja[-5:-3]+'분')
...
"""
print(msg.index('행복'))
print(msg.find('가자')) #find와 index의 차이점 find는 없는애를 -1로 찾고 index는 없으면 에러남
print(msg.rfind('행복'))
print(len(msg))
print(msg.count('도'))
...
#[고민] 문장의 중간에 있는 공백을 지우려면??? replace
print(msg.replace(" ",""))
...
print(msg) #replace는 원본이 훼손되지않음 => 변수를 잡아야함
print(msg.split())
print(','.join(msg))
